  ...
  "reports": [
    {
      ...
      "completed": [
        {
          "title": "文字翻翻卡,词语消消乐,古诗填填乐,三个小游戏的第一版h5内网上线(UI组件,音效,动效)",
          "description": ""
        },
        {
      ...
      "nextPlans": [
        ...
        },
        {
          ...
          "description": "",
          "images": [
            "https://typorabucket0308.oss-cn-beijing.aliyuncs.com/images/20260612061927312.png"
          ]
        },
        {
          "title": "词语消消乐 UI:提示太弱,改成组词消消乐首页顺序调整按照字词句的顺序,词语消消乐优化一下提示,让用户更好理解关卡,组词判定逻辑太简单了,这部分需要优化",
          "description": ""
        },
        {
